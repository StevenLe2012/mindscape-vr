...
namespace Therapist
{
    namespace Oculus.Voice.Demo
    {
        public class TherapistInteractionHandler : MonoBehaviour
        {
            ...
            [SerializeField] private string freshStateText = "Press the 'A' button to begin speaking to the therapist.";
            ...
            [SerializeField] private TherapistChatGPT therapistChatGPT;
            ...
            private void OnRequestResponse(WitResponseNode response)
            {
                if (!showJson)
                {
                    if (!string.IsNullOrEmpty(response["text"]))
                    {
                        ...
                        therapistChatGPT.SendReply(response["text"]);
                    }
                    else
                    {
                        textArea.text = freshStateText;
